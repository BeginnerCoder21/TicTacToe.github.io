document.getElementById('print').innerHTML = "Player 1 will start with X &#128522;";
function myfunc()
{
  ...
  else if (b3 == 'X' && b6 == 'X' && b9 == 'X')
  {
    ...
    else
    {
      if (flag == 1)
      {
          document.getElementById('print').innerHTML = "Player 1 Turn (X)";
      }
      else
      {
          document.getElementById('print').innerHTML = "Player 2 Turn (O)";
      }
    }
}
function myfunc_2()
